...
- Run `make verify` for F*/spec changes, and run `make extract` as well for extraction-relevant executable code, dependency, toolchain, or KaRaMeL configuration changes.
