...
let generated_compressed_answer_name_gate_accepts_valid_test =
  assert_norm (
...
let generated_compressed_answer_name_gate_skips_self_loop_test =
  assert_norm (
    generated_compressed_answer_name_packet_subset_applicable
      self_loop_compressed_answer_name_dns_response == false)
...
let generated_compressed_answer_name_gate_skips_out_of_range_test =
  assert_norm (
    generated_compressed_answer_name_packet_subset_applicable
      out_of_range_compressed_answer_name_dns_response == false)
...
let generated_name_rdata_answer_gate_skips_truncated_name_test =
  assert_norm (
    generated_uncompressed_question_answer_packet_subset_applicable
      truncated_name_rdata_dns_response == false)
...
let compressed_name_rdata_parse_packet_test =
  assert_norm (
    match parse_dns_packet_bytes compressed_name_rdata_dns_response with
    | Some p ->
        L.length p.answers == 1 /\
        (match p.answers with
         | rr :: [] ->
...
let generated_name_rdata_answer_gate_skips_compressed_name_test =
  assert_norm (
    generated_uncompressed_question_answer_packet_subset_applicable
      compressed_name_rdata_dns_response == false)

let generated_compressed_name_rdata_gate_accepts_cname_test =
  assert_norm (
...
let self_loop_compressed_name_rdata_parse_packet_test =
  assert_norm (parse_dns_packet_bytes self_loop_compressed_name_rdata_dns_response == None)

let generated_compressed_name_rdata_gate_skips_self_loop_test =
  assert_norm (
    generated_compressed_name_rdata_packet_subset_applicable
      self_loop_compressed_name_rdata_dns_response == false)

let out_of_range_compressed_name_rdata_dns_response : list FStar.UInt8.t =
  [
    0x12uy; 0x34uy;
    0x81uy; 0x80uy;
    0x00uy; 0x01uy;
...
let out_of_range_compressed_name_rdata_parse_packet_test =
  assert_norm (parse_dns_packet_bytes out_of_range_compressed_name_rdata_dns_response == None)

let generated_compressed_name_rdata_gate_skips_out_of_range_test =
  assert_norm (
    generated_compressed_name_rdata_packet_subset_applicable
      out_of_range_compressed_name_rdata_dns_response == false)
...
let generated_compressed_mx_gate_accepts_exchange_test =
  assert_norm (
...
let generated_compressed_mx_gate_skips_self_loop_test =
  assert_norm (
    generated_compressed_mx_packet_subset_applicable
      self_loop_compressed_mx_exchange_dns_response == false)
...
let generated_compressed_mx_gate_skips_out_of_range_test =
  assert_norm (
    generated_compressed_mx_packet_subset_applicable
      out_of_range_compressed_mx_exchange_dns_response == false)
...
let compressed_soa_mname_parse_packet_test =
  assert_norm (
    match parse_dns_packet_bytes compressed_soa_mname_dns_response with
    | Some p ->
        L.length p.answers == 1 /\
        (match p.answers with
         | rr :: [] ->
...
let generated_soa_answer_gate_skips_compressed_mname_test =
  assert_norm (
    generated_uncompressed_question_answer_packet_subset_applicable
      compressed_soa_mname_dns_response == false)

let generated_compressed_soa_gate_accepts_mname_test =
  assert_norm (
    generated_compressed_soa_packet_subset_applicable
      compressed_soa_mname_dns_response == true)

let compressed_soa_rname_dns_response : list FStar.UInt8.t =
  [
    0x12uy; 0x34uy;
    0x81uy; 0x80uy;
    0x00uy; 0x01uy;
...
let compressed_soa_rname_parse_packet_test =
  assert_norm (
    match parse_dns_packet_bytes compressed_soa_rname_dns_response with
    | Some p ->
        L.length p.answers == 1 /\
        (match p.answers with
         | rr :: [] ->
...
let generated_soa_answer_gate_skips_compressed_rname_test =
  assert_norm (
    generated_uncompressed_question_answer_packet_subset_applicable
      compressed_soa_rname_dns_response == false)

let generated_compressed_soa_gate_accepts_rname_test =
  assert_norm (
    generated_compressed_soa_packet_subset_applicable
...
let self_loop_compressed_soa_mname_parse_packet_test =
  assert_norm (parse_dns_packet_bytes self_loop_compressed_soa_mname_dns_response == None)

let generated_compressed_soa_gate_skips_self_loop_mname_test =
  assert_norm (
    generated_compressed_soa_packet_subset_applicable
      self_loop_compressed_soa_mname_dns_response == false)

let self_loop_compressed_soa_rname_dns_response : list FStar.UInt8.t =
  [
    0x12uy; 0x34uy;
    0x81uy; 0x80uy;
    0x00uy; 0x01uy;
...
let self_loop_compressed_soa_rname_parse_packet_test =
  assert_norm (parse_dns_packet_bytes self_loop_compressed_soa_rname_dns_response == None)

let generated_compressed_soa_gate_skips_self_loop_rname_test =
  assert_norm (
    generated_compressed_soa_packet_subset_applicable
      self_loop_compressed_soa_rname_dns_response == false)

let out_of_range_compressed_soa_name_dns_response : list FStar.UInt8.t =
  [
    0x12uy; 0x34uy;
    0x81uy; 0x80uy;
    0x00uy; 0x01uy;
...
let out_of_range_compressed_soa_name_parse_packet_test =
  assert_norm (parse_dns_packet_bytes out_of_range_compressed_soa_name_dns_response == None)

let generated_compressed_soa_gate_skips_out_of_range_test =
  assert_norm (
    generated_compressed_soa_packet_subset_applicable
...
let boundary_rejects_reference_only_unknown_rr_type_test =
  assert_norm (parse_dns_packet_bytes unknown_rr_type_dns_response <>
               None);
  assert_norm (parse_dns_packet_bytes_at_boundary unknown_rr_type_dns_response ==
               None);
  assert_norm (everparse_boundary_generated_subset_applicable unknown_rr_type_dns_response == false);
  assert_norm (reference_only_acceptance_applicable unknown_rr_type_dns_response == true);
  assert_norm (classify_reference_only_acceptance unknown_rr_type_dns_response ==
...
let boundary_rejects_reference_only_answer_without_question_test =
  assert_norm (parse_dns_packet_bytes serialized_a_answer_response <>
               None);
...
let boundary_rejects_reference_only_multiple_questions_test =
  assert_norm (parse_dns_packet_bytes valid_two_question_dns_query <>
               None);
...
let boundary_rejects_reference_only_authority_record_test =
  assert_norm (parse_dns_packet_bytes valid_authority_ns_dns_response <>
               None);
...
let boundary_rejects_reference_only_nonopt_additional_record_test =
  assert_norm (parse_dns_packet_bytes valid_nonopt_additional_dns_response <>
               None);
...
let boundary_accepts_compressed_name_rdata_test =
...
let boundary_rejects_self_loop_compressed_name_rdata_test =
  assert_norm (parse_dns_packet_bytes_at_boundary self_loop_compressed_name_rdata_dns_response ==
               parse_dns_packet_bytes self_loop_compressed_name_rdata_dns_response)

let boundary_rejects_out_of_range_compressed_name_rdata_test =
  assert_norm (parse_dns_packet_bytes_at_boundary out_of_range_compressed_name_rdata_dns_response ==
               parse_dns_packet_bytes out_of_range_compressed_name_rdata_dns_response)
...
let boundary_accepts_compressed_soa_mname_test =
...
let boundary_rejects_self_loop_compressed_soa_rname_test =
  assert_norm (parse_dns_packet_bytes_at_boundary self_loop_compressed_soa_rname_dns_response ==
               parse_dns_packet_bytes self_loop_compressed_soa_rname_dns_response)
...
let boundary_equivalence_acceptance_lemma_smoke_test =
  assert_norm (everparse_boundary_generated_subset_applicable
                 valid_single_question_dns_query == true);
  assert_norm (parse_dns_packet_bytes valid_single_question_dns_query ==
               Some valid_single_question_dns_packet);
