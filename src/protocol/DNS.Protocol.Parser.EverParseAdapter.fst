...
let generated_dns_uncompressed_question_two_a_answer_packet_validator_linked : bool = true
...
let generated_dns_uncompressed_question_compressed_soa_answer_packet_validator_linked : bool = true

let generated_dns_uncompressed_question_srv_answer_packet_validator_linked : bool = true

let generated_dns_uncompressed_question_compressed_srv_answer_packet_validator_linked : bool = true
...
let generated_dns_uncompressed_question_two_a_answer_packet_validator
    qname_length first_rr_name_length second_rr_name_length =
  DNSProtocol.validate__dns_uncompressed_question_two_a_answer_packet
    qname_length
