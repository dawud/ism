...
| [RFC 6891](https://datatracker.ietf.org/doc/html/rfc6891) | EDNS0 OPT | OPT pseudo-RR | Partial | Parser tests cover valid additional-section OPT, non-root OPT owner rejection, unsupported EDNS version rejection, truncated option rejection, unknown option acceptance, and basic OPT option serialization round-trips. | Full DNS response serializer integration is incomplete. |
