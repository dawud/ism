...
| [RFC 1035](https://datatracker.ietf.org/doc/html/rfc1035) | Resource records | RR NAME, TYPE, CLASS, TTL, RDLENGTH, and RDATA fields | Partial | Tests cover one answer RR, truncated RR headers, and truncated RDATA. | RDATA is preserved by RDLENGTH; type-specific RDATA validation is incomplete. |
