...
compressed MX, SOA, and SRV RDATA pointers outside the current `0xc00c` subset.
These cases remain part of the handwritten reference-parser construction path
