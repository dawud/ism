...
| QUIC stream handling | Stream state transitions and multiplexer operations are admitted. | Resource exhaustion and stream confusion defenses are not yet proven. | Implement stream accumulation, allocation, close, and resource-bound proofs. |
